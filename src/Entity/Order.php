...
class Order
{
    const FOR_1 = "Зачислить ФИО с 01 сентября 2022 г. на математический факультет (1 курс, очная форма 
    обучения) в группу __"; // на зачисление
    const FOR_2 = "Отчислить из университета студента ФИО математического факультета, группы __,
            обучавшегося по основной профессиональной образовательной программе высшего образования "; // на отчисление
    ...
    бюджетных ассигнований федерального бюджета, с 01 сентября 2022 г. по 31 января 2023 г. в размере 
